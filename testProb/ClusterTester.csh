...
set OUTPUT1="/sphenix/user/chase/embedded_direct/0-4fm/XjPhi1_Hijing_embed_0-4fm_output_"$1".root"
set EMBED1="/sphenix/sim/sim01/cd1_review/sHijing/fm_0-4/G4Hits_AuAu200_hijing_0-4fm_"$START"_"$STOP".root"

set OUTPUT2="/sphenix/user/chase/embedded_direct/4-8fm/XjPhi1_Hijing_embed_4-8fm_output_"$1".root"
set EMBED2="/sphenix/sim/sim01/cd1_review/sHijing/fm_4-8/G4Hits_AuAu200_hijing_4-8fm_"$START"_"$STOP".root"

#set OUTPUT="/sphenix/user/chase/embedded_direct/no_embedding/XjPhi1_Hijing_not_embedded_output_"$1".root"
...
#echo root -b -q -l Fun4All_G4_sPHENIX.C\($EVENTS,\"$INPUT\",\"$OUTPUT\",\"$EMBED2\"\) 
#time root -b -q -l Fun4All_G4_sPHENIX.C\($EVENTS,\"$INPUT\",\"$OUTPUT\",\"$EMBED2\"\) 
